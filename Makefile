...
ifeq ($(GOOS),windows)
OUTPUT_PATH = ${BUILD_DIR}/baton-okta-ciam-workforce.exe
else
OUTPUT_PATH = ${BUILD_DIR}/baton-okta-ciam-workforce
endif
...
build: ${GENERATED_CONF}
	go build ${BUILD_TAGS} -o ${OUTPUT_PATH} ./cmd/baton-okta-ciam-workforce
